...
jamovimetarOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamovimetarOptions",
...
jamovimetarResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamovimetarResults",
...
jamovimetarBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamovimetarBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = jamovimetarResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
jamovimetar <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("jamovimetar requires jmvcore to be installed (restart may be required)")
