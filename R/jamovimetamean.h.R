...
jamovimetameanOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamovimetameanOptions",
...
jamovimetameanResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamovimetameanResults",
...
jamovimetameanBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jamovimetameanBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = jamovimetameanResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
jamovimetamean <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("jamovimetamean requires jmvcore to be installed (restart may be required)")
    ...
    analysis <- jamovimetameanClass$new(
        options = options,
        data = data)
