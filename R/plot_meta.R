...
#'
#' @description
#' `plot_meta' returns a ggplot2 object visualizing the results of a meta-analysis, showing
#' each study effect size and CI, the overall effect size and CI as a diamond,
#' effect sizes estimated at each moderator level (if defined), and (optionally)
#' prediction intervals for subsequent studies.
#'
#'
#' @details
...
#' [esci::meta_d2()], [esci::meta_mdiff_two()], [esci::meta_mean()], [esci::meta_pdiff_two()],
#' [esci::meta_proportion()], [esci::meta_r()], [esci::meta_smd_two()]
#'
#'
...
#' @param meta_diamond_height - Optional real number > 0 to indicate height
#' that each meta-analytic diamond should be drawn; defaults to 0.35
