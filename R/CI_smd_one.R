...
#'
#' @param mean A vector of 2 or more means
#' @param sd A vector of standard deviations, same length as means
#' @param n A vector of sample sizes, same length as means
