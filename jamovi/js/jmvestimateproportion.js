    module.exports = {
        ...
        setPanels: function(ui, event) {
            ...
            if (ui.switchs.value()){
              ...
              ui.spanel.expand();
              ui.rpanel.collapse();
              ui.cases.setEnabled(true);
              ui.n.setEnabled(true);
              ui.caselabel1.setEnabled(true);
              ui.caselabel2.setEnabled(true);
            } else {
              ...
              ui.spanel.collapse();
              ui.rpanel.expand();
              ui.cases.setEnabled(false);
              ui.n.setEnabled(false);
              ui.caselabel1.setEnabled(false);
              ui.caselabel2.setEnabled(false);
            }
        }
